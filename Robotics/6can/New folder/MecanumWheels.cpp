...
void MecanumWheels::initWheels(PCA9685 *pca9685_ptr)
{
 ...
 //3
  ...
  // Calibrate for 250m/s at speed=1.0
  MotionConfig[stop].motionCal = 1;
  MotionConfig[fwd].motionCal = 100.0/68.0;
  MotionConfig[rev].motionCal = 100.0/68.0;
  MotionConfig[right].motionCal = 100.0/61.0;
  MotionConfig[left].motionCal = 100.0/61.0;
...
{    
  ...
  float cal = MotionConfig[motion].motionCal; // cal for 250m/s at speed=1.0
