...
if(serialOK) {
Serial.print("moveY prox= "); Serial.print(proximity); Serial.print(", ");
Serial.print("L=");Serial.print(cmL); Serial.print(", ");
Serial.print("R=");Serial.print(cmR); Serial.print(", ");
Serial.print("millis = "); Serial.print(millis() - startMillis); Serial.print("\n");
}
...
if(serialOK) {
Serial.print("senseGoal X L,R = "); Serial.print(wallLX);
...
// position sonar sensors and return R and L cm 
void getSonarProximity(int &cmR, int &cmL)
{
...
Serial.print("Move2Can robot XY = "); Serial.print(robotX); Serial.print(","); Serial.println(robotY);
  ...
  //***************************
  // MRW 4/15 modified to use sonar sensors
...
Serial.print(", R = ");Serial.println(cmR);
    ...
    // measure X after sensor reading
    measRobotX(robotX);
