...
void ObjectDetect::initSonicSensors(PCA9685 *pca9685_ptr, HC_SR04_BASE *sonicSensors_ptr, NanoBleSensors *bleSensors_ptr,
...
Serial.print("LIDAR "); Serial.print(proximity); 
