...
//delay(25); // makes measurement more stable???
    ...
    bool det1R = detectObjects(scanCntDwn==0, rightSensor, robDegR, robDistR, robXR, robYR);
    bool det1L = detectObjects(scanCntDwn==0, leftSensor,  robDegL, robDistL, robXL, robYL);
    scanCntDwn--;
