...
HC_SR04_BASE *sensorL_p;
HC_SR04_BASE *sensorR_p;
HC_SR04_BASE *sensorT_p;

NanoBleSensors *bleSensors_p; // TODO: remove not used
...
float leftServoUsPerDeg  = 11.0; //MRW 5/2 10.6; // calibrated trial and error
int rightSensorServo = 8;
int leftSensorServo = 12;
int sensorError = 35; // accuracy cm - repeatability of sensors at the walls at an angle
...
void initObjectDetect(bool serial_OK, PCA9685 *pca9685_ptr
                      , HC_SR04_BASE *sensorL_ptr, HC_SR04_BASE *sensorR_ptr, HC_SR04_BASE *sensorT_ptr
                      , NanoBleSensors *bleSensors_ptr, int wallAbsX, int wallAbsY );
...
void printRangeSensors(int scanDeg, int scanDistR, int scanDistL, 
                      int degR, int distR, int xR, int yR, 
                      int degL, int distL, int xL, int yL);
void printWhileScanning(int scanDeg, int scanDistR, int scanDistL, 
                      int degR, int distR, int xR, int yR, int degL, 
                      int distL, int xL, int yL);

void getSonarRL(int &cmR, int &cmL, bool quiet=false);
