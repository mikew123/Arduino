...
#define i2cTofAddrL 0x2A /* Left TOF  Cfg*/
#define i2cTofAddrF 0x2B /* Front TOF Cfg*/
#define i2cTofAddrR 0x2C /* Right TOF Cfg*/
#define i2cCurrAddr 0x40
...
//  Serial.println("Found INA228 chip");
  ...
  Serial.println("Battery monitor initialized OK");
...
void loop()
{
  ...
  // Read INA228 sensor 1/sec
  if ((millis() - lastInaMillis) >= 1000) {
    lastInaMillis = millis();
